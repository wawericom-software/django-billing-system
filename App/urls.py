...
urlpatterns = [
    ...
    path('client_update/<int:pk>/', client_views.client_update, name='client_update'),
    path('client_delete/<int:pk>/', client_views.client_delete, name='client_delete'),
    ...
    path('product_update/<int:pk>/', product_views.product_update, name='product_update'),
    path('product_delete<int:pk>/', product_views.product_delete, name='product_delete'),
   ...
   # url routes for refunds
    ...
    path('refund_update/int:pk>/', refund_views.Refund_update, name='Refund_update'),
    path('refund_delete/<int:pk>/', refund_views.Refund_delete, name='Refund_delete'),
    ...
    path('coupon_update/<int:pk>/', coupon_views.coupon_update, name='coupon_update'),
    path('coupon_delete/<int:pk>/', coupon_views.coupon_delete, name='coupon_delete'),
    ...
    path('address_update/<int:pk>/', Address_views.Address_update, name='Address_update'),
    path('address_detail/<int:pk>/', Address_views.Address_delete, name='Address_delete'),
    path('adress_details/', Address_views.adress_details, name='adress_details'),
   ...
   # url routes for payment
    ...
    path('payment_update/<int:pk>/', Payment_views.Payment_update, name='Payment_update'),
    path('payment_delete/<int:pk>/', Payment_views.Payment_delete, name='Payment_delete'),
    ...
    path('payment_invoice_update/<int:pk>/', Payment_invoice_views.payment_invoice_update, name='payment_invoice_update'),
    path('payment_invoice_delete/<int:pk>/', Payment_invoice_views.payment_invoice_delete, name='payment_invoice_delete'),
    ...
    path('package_update/<int:pk>/', package_views.package_update, name='package_update'),
    path('package_delete/<int:pk>/', package_views.package_delete, name='package_delete'),
   ...
   # urls for order items
    ...
    path('order_item_update/<int:pk>/', order_item_views.order_item_update, name='order_item_update'),
    path('order_item_delete/<int:pk>/', order_item_views.order_item_delete, name='order_item_delete'),
   ...
   # urls for orders
    ...
    path('order_update/<int:pk>/', order_views.order_update, name='order_update'),
    path('order_delete/<int:pk>/', order_views.order_delete, name='order_delete'),
    ...
    path('payment_gateway_update/<int:pk>/', payment_gateway_views.payment_gateway_update, name='payment_gateway_update'),
    path('payment_gateway_delete/<int:pk>/', payment_gateway_views.payment_gateway_delete, name='payment_gateway_delete'),
    ...
    path('whatspp_module_update/<int:pk>/', whatspp_module_views.whatspp_module_update, name='whatspp_module_update'),
    path('whatspp_module_delete/<int:pk>/', whatspp_module_views.whatspp_module_delete, name='whatspp_module_delete'),
    ...
    path('sms_module_update/<int:pk>/', sms_module_views.sms_module_update, name='sms_module_update'),
    path('sms_module_delete/<int:pk>/', sms_module_views.sms_module_delete, name='sms_module_delete'),
    ...
    path('email_module_update/<int:pk>/', email_module_views.email_module_update, name='email_module_update'),
    path('email_module_delete/<int:pk>/', email_module_views.email_module_delete, name='email_module_delete'),
    ...
    path('campaign_update/<int:pk>/', campaign_views.campaign_update, name='campaign_update'),
    path('campaign_delete/<int:pk>/', campaign_views.campaign_delete, name='campaign_delete'),
   ...
   # urls for contact configuration
    ...
    path('contact_update/<int:pk>/', contact_views.contact_update, name='contact_update'),
    path('contact_delete/<int:pk>/', contact_views.contact_delete, name='contact_delete'),
    ...
    # urls for renewals 
    path('renewal/', renewal_views.renewal_create, name='renewal_create'),
    path('renewal/<int:pk>/', renewal_views.renewal_detail, name='renewal_detail'),
    path('renewal_update/<int:pk>/', renewal_views.renewal_update, name='renewal_update'),
